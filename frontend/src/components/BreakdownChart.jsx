...
export default function BreakdownChart({ breakdown = {} }) {
 ...
 return (
 <div className="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between w-full">
 <div>
 <h3 className="text-sm font-semibold text-slate-500 mb-6">Evaluation Category Breakdown</h3>
