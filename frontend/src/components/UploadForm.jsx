    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold text-slate-500 dark:text-slate-400 mb-2">Resume File (PDF / DOCX)</label>
          <div
            ...
            className={`flex-1 flex flex-col items-center justify-center border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-colors duration-200 min-h-[220px] ${
              dragActive 
                ...
                : file 
                  ...
                  : 'border-slate-300 hover:border-blue-500 dark:border-slate-800'
            }`}
          >
            <input
              ref={fileInputRef}
            ...
            {file ? (
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Drag & drop your resume here, or <span className="text-blue-500 underline">browse</span></p>
        ...
        <div className="flex flex-col">
          <label htmlFor="jd-input" className="text-sm font-semibold text-slate-500 dark:text-slate-400 mb-2">
          ...
          <textarea
            ...
            className="flex-1 w-full rounded-2xl border border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none dark:text-white"
          />
        </div>
      </div>

      {error && (
        <div className="flex items-center gap-3 p-4 bg-red-50 dark:bg-red-950/20 text-red-700 dark:text-red-400 rounded-xl border border-red-200 dark:border-red-900/50">
      ...
      >
        {loading ? 'Analyzing with Google Gemini...' : 'Analyze & Score Resume'}
      </button>
    </form>
  );
}
